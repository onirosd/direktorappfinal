                  ...
                  <td align="left" valign="top" style="padding:0;Margin:0;">
                    ...
                    <td align="left" style="padding:20px;Margin:0;width:520px">
                      ...
                      <h3 style="Margin:0;line-height:34px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:28px;font-style:normal;font-weight:bold;color:#2D3142">
                        Se alertan modificaciones en el proyecto {{$des_proyecto}}<br>
                        ...
                        <table border="0" bordercolor="#cccccc" align="center" class="es-table">
                          <tbody>
                            <tr style="background-color: #0062ae; height:50px; color: #fff;">
                              ...
                              <td style="font-family: manrope, arial, sans-serif; text-align: center; font-size: 14px;">Tipo</td>
           ...
           <table bgcolor="#efefef" class="es-content-body" align="center" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#EFEFEF;border-radius:0 0 20px 20px;width:600px">
             <tr>
              <td class="esdev-adapt-off" align="left" style="Margin:0;padding-top:20px;padding-bottom:20px;padding-left:40px;padding-right:40px">
               <table cellpadding="0" cellspacing="0" class="esdev-mso-table" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:895px">
                 <tr>
