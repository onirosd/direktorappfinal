        ...
        <table cellpadding="0" cellspacing="0" class="es-content" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%">
            <tr>
              <td align="center" style="padding:0;Margin:0">
                 <table bgcolor="#efefef" class="es-content-body" align="center" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#EFEFEF;border-radius:20px 20px 0 0;width:800px">
                    <tr>
                  ...
                  <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                    <tr>
                      ...
                      <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#fafafa" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;background-color:#fafafa;border-radius:10px" role="presentation">
                              <tr>
                          <td align="left" style="padding:20px;Margin:0"><h3 style="Margin:0;line-height:34px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:28px;font-style:normal;font-weight:bold;color:#2D3142">
                            ...
                            <table border="0" bordercolor="#cccccc" align="center" class="es-table">
                              <tbody>
                                <tr style="background-color: #0062ae; height:50px; color: #fff;">
                                  ...
                                  <td style="font-family: manrope, arial, sans-serif; text-align: center; font-size: 14px;">Estado</td>
                                  <td style="font-family: manrope, arial, sans-serif; text-align: center; font-size: 14px;">Fecha Requerida</td>
                                  <td style="font-family: manrope, arial, sans-serif; text-align: center; font-size: 14px;">Fecha Conciliada</td>
                                  <td style="font-family: manrope, arial, sans-serif; text-align: center; font-size: 14px;">Fecha de Rechazo</td>
                                ...
                                <tr style="height:50px">
                                  <td style="font-family: manrope, arial, sans-serif; text-align: center; font-size: 14px;">{{$actividades[0]['frente']}}</td>
                                  <td style="font-family: manrope, arial, sans-serif; text-align: center; font-size: 14px;">{{$actividades[0]['fase']}}</td>
                                  <td style="text-align: center; font-family: manrope, arial, sans-serif; font-size: 12px;">{{$actividades[0]['desActividad']}}</td>
                                  <td style="text-align: center; font-family: manrope, arial, sans-serif; font-size: 12px;">{{$actividades[0]['desRestriccion']}}</td>
                                  <td style="text-align: center; font-family: manrope, arial, sans-serif; font-size: 12px; background-color: #e10909;color: #fff;">{{$actividades[0]['estado']}}</td>
                                  <td style="text-align: center; font-family: manrope, arial, sans-serif; font-size: 12px;">{{$actividades[0]['fecharequerida']}}</td>
                                  <td style="text-align: center; font-family: manrope, arial, sans-serif; font-size: 12px;">{{$actividades[0]['fechaconciliada']}}</td>
                                  <td style="text-align: center; font-family: manrope, arial, sans-serif; font-size: 12px;">{{$actividades[0]['fecharechazo']}}</td>
                    ...
                    <tr>
                      <td align="center">
                        <br>
                        <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#2D3142;font-size:16px">Mensaje automatico , favor de no responder a este correo.</p>
                        <br>
                      </td>
                    </tr>
                  </table>
