  ...
  <section class="bg-gray-50 min-h-screen flex items-center justify-center">
   ...
   <div v-if="visibility" class="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
     ...
     <div class="md:w-1/2 px-2 md:px-4">
       ...
       <p class="text-xs mt-4 text-[#002D74]">Ingresa la nueva contraseña y tambien la confirmación de la contraseña. </p>

       <form  class="flex flex-col gap-4" @submit="submitResetPassword">
         <Alert v-if="errorMsg">
           {{ errorMsg }}
           <span
             @click="errorMsg = ''"
        ...
        <div class="">
         ...
         <div class="relative">
          ...
          >
          <svg @click="togglePasswordVisibility" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray" class=" cursor-pointer bi bi-eye absolute top-1/2 right-3 -translate-y-1/2" viewBox="0 0 16 16">
        ...
        <div class="">
         ...
         <TButtonLoading :loading="loading" class="bg-[#002D74] rounded-xl text-white py-2 hover:scale-105 duration-300">
