  ...
  <section class="bg-gray-50 min-h-screen flex items-center justify-center">
   ...
   <div class="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
     ...
     <div class="md:w-1/2 px-2 md:px-4">
       <h2 class="font-bold text-2xl text-[#002D74]">¿ Olvidaste tu contraseña ? </h2>
       ...
       <div class="mt-5 text-xs border-b border-[#002D74] py-4 text-[#002D74]">
        <a class="cursor-pointer hover:scale-105" @click="handleRedirect('login')">Tienes cuenta de Direktor ?</a>
  ...
  export default {
    ...
    methods:{
     ...
     login(ev) {
             ...
             this.loading = true;
             store
               .dispatch("recoverPasswordSolicitude", this.user)
               .then(res => {
                 this.loading = false;
                 //router.getRoutes()
                 this.$router.push({
